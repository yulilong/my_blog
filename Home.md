...
* [**Mac下一些终端命令**](https://bitbucket.org/yulilong/my_wiki/wiki/Mac下一些终端命令)      终端配置代理
...
* [virtualbox虚拟机 centos7安装增强工具](https://bitbucket.org/yulilong/my_wiki/wiki/virtualbox虚拟机%20centos7安装增强工具)     
* [**vim编辑器常用命令与用法总结**](https://bitbucket.org/yulilong/my_wiki/wiki/vim编辑器常用命令与用法总结)      
* [**Terminal终端快捷键**](https://bitbucket.org/yulilong/my_wiki/wiki/Terminal终端快捷键)      
